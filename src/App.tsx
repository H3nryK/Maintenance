...
const App: React.FC = () => {
  return (
    ...
    >
      <header className="py-5 bg-black bg-opacity-70 w-full text-center">
      ...
      <main className="flex flex-col items-center my-10 bg-black bg-opacity-70 p-5 rounded-lg">
      ...
      <div className="fixed bottom-5 right-5 bg-black bg-opacity-70 p-4 rounded-lg shadow-lg">
        <p>Contact us: info@milimanihighschool.co.ke</p>
      </div>
    </div>
  );
