          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200 mt-6">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <p><strong>Username:</strong> {isEditing ? <input value={userProfile.username} onChange={(e) => setUserProfile({...userProfile, username: e.target.value})} /> : userProfile.username}</p>
                <p><strong>Level:</strong> {userProfile.level}</p>
                <p><strong>XP:</strong> {userProfile.xp}</p>
                <p><strong>Wallet Balance:</strong> {userProfile.tokens} SKN</p>
                <div>
              ...
              {isEditing ? (
                <button 
                  ...
                  className="mt-6 bg-green-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-green-700 transition duration-300"
                >
                  Save Profile
                </button>
              ) : (
