...
import { idlFactory } from './skillnet_frontend.did.js';
export { idlFactory } from './skillnet_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILLNET_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skillnet_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skillnet_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skillnet_frontend.did.js")._SERVICE>}
 */
export const skillnet_frontend = createActor(canisterId);
