...
import { idlFactory } from './skillnet_backend.did.js';
export { idlFactory } from './skillnet_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILLNET_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skillnet_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skillnet_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skillnet_backend.did.js")._SERVICE>}
 */
export const skillnet_backend = createActor(canisterId);
